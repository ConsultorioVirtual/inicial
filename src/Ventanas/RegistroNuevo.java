...
public class RegistroNuevo extends javax.swing.JFrame {
    ...
    public RegistroNuevo() {
        initComponents();
        setTitle("REGISTRO DE USUARIO INICIAL");
...
//mouseclicked
    ...
    public void insertarAsistente(String id_usu){
         String idRecep = getRowNumber("recepcionista")+1+"";   
           try{
               PreparedStatement pst=cn.prepareStatement("INSERT INTO recepcionistarecepcionista"
                       + "(id_recepcionista,domicilio,ciudad,estado,codigo_postal,tel_domicilio,"
                       + "tel_oficina,tel_movil,tel_extra,correo_electronico,id_usuario)"
                       + "VALUES(?,?,?,?,?,?,?,?,?,?,?)"); 
               pst.setString(1,idRecep);
               ...
               pst.setString(9,null);
               pst.setString(10,null);
               pst.setString(11,id_usu);
              
              
        int a=pst.executeUpdate();
         if(a>0){
               showMessageDialog(null,"Registro de asistente exitoso");
                //mostrardatos("");
           }
           else{
                showMessageDialog(null,"Error al agregar");
